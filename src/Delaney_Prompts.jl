                        ...
                        for approach in approaches
                            ...
                            if num_extended_training_samples > 0
                                ...
                                if approach == "input_output_prompting" || approach == "with_preanalysis"
                                    target_column_label = target_column
                                elseif approach == "wp_solubility_blind"
                                    target_column_ = transformed_solubility_column
                                    target_column_label = "molecular property related to solubility"
...
**Your Role**
You are a professional chemist with expert knowledge in physical chemistry and solubility prediction.
You are tasked with predicting the log solubility (log(mol/L)) of organic molecules in water based on their IUPAC names and SMILES strings.

**Problem Description**
Solubility is a key property in drug discovery and agrochemistry.
You will be provided with:
1. A training dataset of molecules with their Names, SMILES, and known solubility values.
2. A test molecule (Name and SMILES) for which you must predict the solubility.

You have to use your knowledge and abilities to analyze the training datas molecules and the patterns and relationships between molecular properties and solubility to make an accurate prediction.
"""
...
**Prediction Task:**
Predict the log solubility for the following molecule:
- Name: <molecule_name>
...
**Your Role**
You are a professional chemist with expert knowledge in physical chemistry and solubility prediction.
You are tasked with predicting the log solubility (log(mol/L)) of organic molecules in water based on their Names, SMILES, and molecular descriptors.

**Problem Description**
You will be provided with:
1. A training dataset with Names, SMILES, Descriptors (MW, Rings, Rotatable Bonds, H-Donors, TPSA), and solubility values.
...
**Prediction Task:**
Predict the log solubility for:
- Name: <molecule_name>
- SMILES: <smiles_string>
...
prompts["names_only"]["with_preanalysis"]["analysis"] = """
    ...
    **Analysis Task:**
    ...
    2. Analyze how these features influence the solubility (e.g., hydrophilic vs hydrophobic groups).
    3. Find pairs of similar molecules with different solubilities and explain the difference.
...
**Your Role**
You are a professional chemist with expert knowledge in physical chemistry and solubility prediction.
You are tasked with predicting a molecular property related to solubility of organic molecules in water based on their IUPAC names and SMILES strings.
...
prompts["names_only"]["wp_solubility_blind"]["analysis"] = """
    **Training Data:**
    - Names: <molecule_names_training>
    - SMILES: <smiles_strings_training>
    - molecular property related to solubility: <transformed_solubilities_training>

    **Analysis Task:**
    1. Identify functional groups and structural features for each training sample.
    2. Analyze how these features influence the molecular property related to solubility (e.g., hydrophilic vs hydrophobic groups).
    3. Find pairs of similar molecules with different solubilities and explain the difference.
...
prompts["names_only"]["wp_solubility_blind"]["prediction"] = """
    ...
    **Similar Molecules Relations**
    1. Similar Molecules: Find all similar molecules in the training data and analyze their relation to this compound wrt the molecular property related to solubility. 
    ...
    **Molecule Analysis**
    3. Pattern Analysis: Analyze if found patterns apply to the molecule
    4. Functional Groups: Analyze its functional groups and their influence on the molecular property related to solubility
    5. Atomic Structure: Analyze its atomic structure and how this might influence the molecular property related to solubility
    6. Weighted Average: Calculate a weighted average of the molecular properties related to solubility of the similar molecules. 
    Exclude molecules that have a small similarity value.
