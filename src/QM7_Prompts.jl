                        ...
                        for approach in approaches
                            ...
                            if num_extended_training_samples > 0
                                ...
                                if approach == "input_output_prompting" || approach == "with_preanalysis"
                                    target_column_label = "atomization energy"
                                elseif approach == "wp_solubility_blind"
                                    target_column_ = transformed_solubility_column
                                    target_column_label = "molecular property related to atomization energy"
...
**Your Role**
You are a professional quantum mechanics expert with expert knowledge in quantum mechanics and atomization energy prediction.
You are tasked with predicting the atomization energy (kcal/mol) of organic molecules based on their SMILES strings.

**Problem Description**
Atomization energy is a key property in quantum mechanics.
You will be provided with:
1. A training dataset of molecules with their SMILES, and known atomization energies.
2. A test molecule (SMILES) for which you must predict the atomization energy.

You have to use your knowledge and abilities to analyze the training datas molecules and the patterns and relationships between molecular properties and atomization energy to make an accurate prediction.
"""

prompts["names_only"]["input_output_prompting"]["prediction"] = """
**Training Data:**
- SMILES: <smiles_strings_training>
- Atomization Energy (kcal/mol): <solubilities_training>

**Prediction Task:**
Predict the atomization energy for the following molecule:
...
**Your Role**
You are a professional quantum mechanics expert with expert knowledge in quantum mechanics and atomization energy prediction.
You are tasked with predicting the atomization energy (kcal/mol) of organic molecules based on their SMILES strings and molecular descriptors.

**Problem Description**
You will be provided with:
1. A training dataset with SMILES, Descriptors (MW, Rings, Rotatable Bonds, H-Donors, TPSA), and atomization energies.
...
**Prediction Task:**
Predict the atomization energy for:
- SMILES: <smiles_string>
...
prompts["names_only"]["with_preanalysis"]["analysis"] = """
    ...
    **Analysis Task:**
    ...
    2. Analyze how these features influence the atomization energy.
    3. Find pairs of similar molecules with different atomization energies and explain the difference.
...
prompts["names_only"]["with_preanalysis"]["prediction"] = """
    ...
    **Similar Molecules Relations**
    1. Similar Molecules: Find all similar molecules in the training data and analyze their relation to this compound wrt the atomization energy 
    process. Use the training data and the analyzed training data.
    2. Similarity Analysis: Analyze similar molecules and rank them by similarity (wrt the mechanisms in the atomization energy process). 
    Assign them a similarity value (wrt the mechanisms in the atomization energy process).
    
    **Molecule Analysis**
    3. Pattern Analysis: Analyze if found patterns apply to the molecule
    4. Functional Groups: Analyze its functional groups and their influence on the atomization energy
    5. Atomic Structure: Analyze its atomic structure and how this might influence the atomization energy
    6. Weighted Average: Calculate a weighted average of the atomization energies of the similar molecules. 
...
**Your Role**
You are a professional quantum mechanics expert with expert knowledge in quantum mechanics and atomization energy prediction.
You are tasked with predicting a molecular property related to atomization energy of organic molecules based on their SMILES strings.

**Problem Description**
You will be provided with:
1. A training dataset of molecules with their SMILES and known values of the molecular property related to atomization energy.
...
**Your Role**
You are a professional quantum mechanics expert with expert knowledge in quantum mechanics.
...
prompts["names_only"]["wp_solubility_blind"]["analysis"] = """
    **Training Data:**
    - SMILES: <smiles_strings_training>
    - molecular property related to atomization energy: <transformed_solubilities_training>

    **Analysis Task:**
    1. Identify functional groups and structural features for each training sample.
    2. Analyze how these features influence the molecular property related to atomization energy.
    3. Find pairs of similar molecules with different atomization energies and explain the difference.
...
prompts["names_only"]["wp_solubility_blind"]["prediction"] = """
    ...
    **Similar Molecules Relations**
    1. Similar Molecules: Find all similar molecules in the training data and analyze their relation to this compound wrt the molecular property related to atomization energy. 
    ...
    **Molecule Analysis**
    3. Pattern Analysis: Analyze if found patterns apply to the molecule
    4. Functional Groups: Analyze its functional groups and their influence on the molecular property related to atomization energy
    5. Atomic Structure: Analyze its atomic structure and how this might influence the molecular property related to atomization energy
    6. Weighted Average: Calculate a weighted average of the molecular properties related to atomization energy of the similar molecules. 
    Exclude molecules that have a small similarity value.
